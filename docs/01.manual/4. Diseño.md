...
| Color | Nombre | Hexadecimal | Uso |
|-------|--------|-------------|-----|
| Primary | Violeta Lumen | `#6D5DFB` | Botones principales, acentos,图标 |
| Primary Dark | Violeta Oscuro | `#4A3FDB` | Estados hover, énfasis |
| Secondary | Ámbar | `#F59E0B` | Alertas, advertencias |
| Success | Verde | `#10B981` | Confirmaciones, objetivos cumplidos |
| Error | Rojo | `#EF4444` | Errores, sobrepresupuesto |
| Background | Blanco Puro | `#FFFFFF` | Fondos principales |
| Surface | Gris Claro | `#F9FAFB` | Tarjetas, superficies elevadas |
| Text Primary | Negro | `#111827` | Texto principal |
| Text Secondary | Gris | `#6B7280` | Texto secundario, etiquetas |
| Border | Gris Borde | `#E5E7EB` | Bordes, separadores |
...
```css
/* Sombra pequeña: botones, inputs */
box-shadow: 2px 2px 0px 0px #000000;

/* Sombra media: tarjetas */
box-shadow: 4px 4px 0px 0px #000000;

/* Sombra grande: modals, elementos flotantes */
...
|----------|---------|------|--------|
| Títulos grandes | Inter | 800 (ExtraBold) | 32px |
| Títulos medianos | Inter | 700 (Bold) | 24px |
| Subtítulos | Inter | 600 (SemiBold) | 18px |
| Cuerpo de texto | Inter | 400 (Regular) | 16px |
| Etiquetas | Inter | 500 (Medium) | 14px |
| Texto pequeño | Inter | 400 (Regular) | 12px |
