...
Este manual describe la instalación, configuración y ejecución de todos los componentes del proyecto Lumen. Todos los comandos asumen que el lector se encuentra en el directorio raíz del proyecto (donde residen las carpetas `mobile-app/`, `api-main/`, `ocr-processor/` y `landing-page/`).
...
| **Nota:** Las rutas son relativas al directorio raíz del proyecto. | | | |
